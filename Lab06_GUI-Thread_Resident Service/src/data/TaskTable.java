...
public class TaskTable {
	...
	public void setTableProperty() {
		...
		taskRewardCol.setCellValueFactory(new PropertyValueFactory<Task, Integer>("reward"));
		...
		taskProgressCol.setCellValueFactory(new PropertyValueFactory<Task, Double>("progress"));
		taskProgressCol.setCellFactory(ProgressTableCell.<Task>forTableColumn());

		taskProgressCol.setOnEditCommit(new EventHandler<CellEditEvent<Task, Double>>() {
			@Override
